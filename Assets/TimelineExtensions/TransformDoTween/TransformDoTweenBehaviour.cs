...
public class TransformDoTweenBehaviour : BaseTransformBehaviour
{
    ...
    public override void OnPlayableDestroy (Playable playable)
    {
        ...
        DOTween.Kill (positionTweener);
        DOTween.Kill (rotationTweener);
